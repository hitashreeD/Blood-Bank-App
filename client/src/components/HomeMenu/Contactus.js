              ...
              <div className="row">
                <div className="col-md-8" style={{ textAlign: "left" }}>
                  ...
                  <p >
                    ...
                    <strong>Address:</strong> Nandurbar, Maharashtra <br />
                    <strong>Contact:</strong> +91 8975149131 <br />
                    <strong>Email:</strong> hitashreedeore6999@gmail.com
                  </p>
                </div>
                <div className="col-md-4">
                  <div style={{ textAlign: "right" }}>
                    ...
                    <Link to="https://github.com/hitashreeD" style={{ color: "black", fontSize: "1.5rem", display: "block", textDecoration: "none" }}><CgWebsite /> Website</Link>
                  </div>
                </div>
              </div>
            </div>
